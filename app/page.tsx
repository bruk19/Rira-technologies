...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-gray-950 text-white relative overflow-x-hidden">
      ...
      <section id="services" className="md:py-20 py-14 px-4 relative z-10">
        <div className="container mx-auto max-w-6xl">
          <ScaleOnScroll>
      ...
      <section id="products" className="py-20 pb-20 px-4 relative z-10 bg-black">
        <div className="container mx-auto max-w-6xl">
          <ScaleOnScroll>
            <div className="text-center mb-16">
              <h2 className="md:text-4xl text-2xl font-semibold mb-6 text-white">
      ...
      <section id="solutions" className="md:py-8 py-6 px-4 relative z-10 bg-black">
        <div className="container mx-auto max-w-6xl">
          <ScaleOnScroll>
            <div className="text-center mb-16">
              <h2 className="md:text-4xl text-2xl font-semibold mb-6 text-white">Web3 Solutions for Every Use Case</h2>
              <p className="md:text-lg text-sm text-gray-400 max-w-2xl mx-auto">
            ...
            {[
              ...
              <ScrollReveal key={index} delay={index * 0.1}>
                <Card className="bg-gray-900 border-gray-800 hover:border-gray-700 transition-all duration-500 hover:scale-105 group h-full">
                  <CardContent className="md:p-8 p-4 h-full">
                    <div className="flex items-start gap-4 h-full">
                      <div className="text-gray-400 group-hover:text-gray-300 transition-colors duration-300 flex-shrink-0 mt-1">
                        {item.icon}
                      </div>
                      <div className="flex flex-col h-full">
                        <h3 className="md:text-xl text-[17px] font-semibold text-white mb-3 group-hover:text-gray-100 transition-colors">
                          {item.title}
                        </h3>
                        <p className="text-gray-400 group-hover:text-gray-300 transition-colors leading-relaxed flex-grow md:text-[16px] text-sm">
                          {item.description}
                        </p>
                      </div>
                    </div>
      ...
      <section className="md:py-20 py-14 px-4 relative z-10 bg-black">
        <div className="container mx-auto max-w-6xl">
          <ScaleOnScroll>
            <div className="text-center mb-12">
              <h2 className="md:text-4xl text-2xl font-semibold mb-6 text-white">Our Commitment to Your Success</h2>
              <p className="md:text-lg text-sm text-gray-400">Discover the impact of our work:</p>
            </div>
          </ScaleOnScroll>
          ...
          <ScrollReveal delay={0.4}>
            <p className="text-center mt-12 text-gray-400 md:text-lg text-[15px]">
